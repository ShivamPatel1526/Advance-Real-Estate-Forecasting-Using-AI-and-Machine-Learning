...
This project is a complete machine learning pipeline that generates synthetic housing data, trains a prediction model, and offers a user-friendly interface using Streamlit to estimate house prices.
...
This keeps the model dynamic and allows it to simulate real-world scenarios effectively.
...
⚙️ How It Works
generate_data.py creates a dataset with features like area, bedrooms, bathrooms, and more.  
